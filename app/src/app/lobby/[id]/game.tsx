      ...
      <Card className="w-full max-w-5xl bg-white shadow-2xl">
        ...
        <CardContent className="">
          <div className="flex flex-col gap-6">
            ...
            {me &&
              lobby.currentGame.rounds[lobby.currentGame.rounds.length - 1]
                .currentStage.type === "LEGISLATIVE" && (
                <LegislativeStage
                  player={me}
                  round={
                    lobby.currentGame.rounds[
                      lobby.currentGame.rounds.length - 1
                    ]
                  }
                  stage={
                    lobby.currentGame.rounds[
            ...
            <CardFooter className="flex justify-center">
              <Button size="lg">Próximo Turno</Button>
            </CardFooter>
          </div>
        </CardContent>
      </Card>
