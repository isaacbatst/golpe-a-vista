...
import { SabotageCardDTO, MensalaoAction, MensalaoDTO } from "@/lib/api.types";
...
const Mensalao = ({ effect, sabotageCard, controlledBy }: Props) => {
  const timeLeft = useTimer(effect.timeToAdvance);
  const { player } = usePlayerContext();
  const { sabotageCardStageApply, sabotageCardStageMensalaoChoosePlayers } =
    ...
    return (
      <div className="flex flex-col items-center gap-4">
        ...
        <div className="max-w-lg flex flex-col items-center gap-4">
          ...
          <SabotageCardCard sabotageCard={sabotageCard!} isOverlayFixed />
        </div>
        ...
        <Button
          ...
          onClick={() => {
            ...
            sabotageCardStageMensalaoChoosePlayers(selectedPlayers);
          }}
        >
          <Check />
          Escolher
  ...
  return (
    <div className="flex flex-col items-center gap-4">
      ...
      <div className="space-y-4">
        ...
        <p className="text-muted-foreground text-sm max-w-lg text-center">
          Uma sabotagem <strong>pode</strong> estar se formando, mas nada chegou ao
          seu gabinete.
        </p>
      </div>
